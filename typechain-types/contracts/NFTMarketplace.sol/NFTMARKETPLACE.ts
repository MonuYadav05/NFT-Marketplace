...
export interface NFTMARKETPLACEInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getListedForTokenId",
    values: [BigNumberish]
  ): string;
...
export interface NFTMARKETPLACE extends BaseContract {
  ...
  executeSale: TypedContractMethod<[_tokenId: BigNumberish], [void], "payable">;
  ...
  getListedForTokenId: TypedContractMethod<
  ...
  idToListedToken: TypedContractMethod<
    [arg0: BigNumberish],
    [
  ...
  getFunction(
    nameOrSignature: "getListedForTokenId"
  ): TypedContractMethod<
    [_tokenId: BigNumberish],
    [NFTMARKETPLACE.ListedTokenStructOutput],
    "view"
  ...
  getFunction(
    nameOrSignature: "idToListedToken"
  ): TypedContractMethod<
    [arg0: BigNumberish],
    [
      [bigint, string, string, bigint, boolean] & {
  ...
  ): TypedContractMethod<[_newPrice: BigNumberish], [void], "payable">;
